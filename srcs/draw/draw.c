...
/*   Updated: 2022/06/01 09:53:09 by vvandenb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_floor_ceiling(t_img *img, int *colors)
{
	img_square_put(img, colors[1], (t_point){0, 0},
		(t_point){GAME_WIDTH, SCREEN_HEIGHT / 2});
	img_square_put(img, colors[0],
		(t_point){0, SCREEN_HEIGHT / 2},
		(t_point){GAME_WIDTH,
